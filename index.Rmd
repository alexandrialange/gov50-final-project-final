---
title: "The Effects Of Smoking During Pregnancy"
...
The P value is less than 0.001. This is highly statistically significant and tells us that observing a correlation statistic of 0.109 or more extreme is very unlikely under the first null hypothesis.Therefore, there is evidence to support the first part of the first alternative hypothesis that there is positive correlation between smoking habits and the likelihood of premature birth, and we can reject the null hypothesis.
...
0.14824= the average change (increase) in the probability of a baby being born with a classified "low birth weight" when the mother has a habit of smoking 
...
The P value for smoking habits of the mother (habitsmoker) is less than 0.001. This is highly statistically significant and tells us that observing a correlation statistic of 0.148 or more extreme is unlikely under the first part of the second null hypothesis, so we would reject it.Therefore, there is evidence to support the first part of the second alternative hypothesis that there is positive correlation between smoking habits and the likelihood of low birth weight.
...
#### Interpretation of Linear Regression:
 ...
 0.124498= about 12.5%= the average change (increase) in the average probability of a baby being born with a classified "low birth weight" when the mother has a habit of smoking (when mothers are the same age)
...
When comparing the linear regression coefficient of habitsmoker in this mutli regression when is it is 0.124498 and the regression above when it is 0.14824, the average increase in probability of a baby being born at a low birth weight is only 0.023782 smaller when the confounding factor of mother's age is not taken into account. Thus, it works to emphasize how much big of an impact smoking has on the probability  of a child being born with a low birth weight even with a possible confounding factor being included. 
...
Overall, the null hypothesis that smoking does cause premature birth and low birth weight to be more likely was rejected every time it was evaluated; the null hypothesis that (an increase in) mother's age does cause premature birth and low birth weight to be more likely failed to be rejected both times it was evaluated. 

Thus, if a mother smoked, it was found to increase the probability of her baby being born prematurely and/or with a low birth weight. While its effect on these probabilities remained somewhat constant with the inclusion of one possible confounding variable (mother's age/ "fage"), there are many other possible confounding factors that, if tested alongside smoking habits, may cause the effects of smoking on the two dependent variables mentioned previously to dwindle in comparison. Therefore, I am unable to confidently conclude causality between smoking habits and preterm labor and/or low birth weight. 
